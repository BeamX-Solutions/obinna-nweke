          ...
          <div>
            ...
            <div className="space-y-4">
              {publications.map((pub, index) => (
                ...
                <div
                  className="bg-white rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 border border-slate-200 transform hover:-translate-y-1 hover:border-blue-200"
                >
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-50 to-amber-50 rounded-xl p-8 text-center border border-blue-100">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {[
              ...
              <span
                key={index}
                className="bg-white px-4 py-2 rounded-full text-sm font-medium text-slate-700 shadow-sm border border-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md hover:border-blue-300 hover:text-blue-700 cursor-default"
              >
                {area}
              </span>
            ))}
